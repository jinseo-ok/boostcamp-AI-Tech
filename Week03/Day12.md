...
Convolution 연산의 경우, 커널의 모든 입력 데이터에 대해 공통적으로 적용 되기 때문에 역전파를 계산하는 경우에도 똑같이 Convolution 연산이 출력됩니다. 강의에서 그림과 함께 잘 설명되어 있기 때문에 커널을 통해 gradient가 전달되는 과정과 역전파 과정에 대해 이해하고 있는 것이 좋습니다.
