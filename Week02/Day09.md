...
데이터를 병합할 때, SQL의 join과 같이 key값(on)을 기준으로 데이터를 병합할 때는 `merge` 를 사용하고 단순 행과 열로 데이터를 합칠 때는 `concat`을 사용합니다.
...
#### 1) 확률 변수 (Random Variable) [[참고자료]](https://devkihyun.github.io/study/Machine-learining-and-Probability/)
...
![image](https://user-images.githubusercontent.com/48677363/106426142-6c593100-64a8-11eb-9a60-77a5716b050f.png)
